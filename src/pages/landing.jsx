...
const LandingPage = () => {
  ...
  return (
      <div className="flex flex-col items-center px-4">
          <h2 className="my-10 sm:my-16 text-3xl sm:text-6xl lg:text-7xl text-white text-center font-extrabold max-w-4xl">
              The only URL Shortner <br /> you'll ever need!
          </h2>

          <form onSubmit={handleShorten} className="sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2 max-w-3xl">
              <Input
                  type="url"
                  value={longUrl}
          ...
          <div className="w-full max-w-4xl my-11 px-4">
              <img src="/banner1.jpg" alt="banner" className="w-full rounded-lg" />
          </div>

          <Accordion type="single" collapsible className="w-full md:px-11 max-w-3xl">
              <AccordionItem value="item-1">
                  <AccordionTrigger>How does the Trimrr URL Shortner work?</AccordionTrigger>
                  <AccordionContent>
              ...
              <AccordionItem value="item-2">
                  <AccordionTrigger>Do I need an account to create URLs?</AccordionTrigger>
                  <AccordionContent>
